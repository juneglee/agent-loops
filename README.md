...
스택 = 코어 루프 [+ 조합] [+ 하네스 층]. 예: `react`, `planner+react`, `react+todo`
...
| 층 | 동작 | 파일 |
|---|---|---|
| `+todo` | 루프가 매 스텝 갱신하는 할 일 목록을 프롬프트에 외부화한다 (도구 `update_todo` 추가) | `harness/todo.py` |
...
| 스택 | 1T1S | 1TMS | MTMS |
|---|---|---|---|
| `react+todo` | 100.0 / 2.7 / 8 | 71.4 / 3.9 / 21 | 84.6 / 11.2 / 66 |
| `react+verifier` | 100.0 / 2.7 / 9 | 57.1 / 3.7 / 18 | 76.9 / 11.8 / 81 |
| `single_call+todo` | 100.0 / 1.0 / 10 | 0.0 / 1.0 / 18 | 23.1 / 3.4 / 33 |
| `single_call+verifier` | 100.0 / 1.0 / 12 | 0.0 / 1.0 / 12 | 23.1 / 3.4 / 33 |
| `codeact+todo` | 100.0 / 2.5 / 15 | 57.1 / 3.3 / 28 | 61.5 / 10.2 / 106 |
